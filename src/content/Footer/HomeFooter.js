        ...
        axios
          ...
          .catch((err) => {
            setAlert({
              severity: "error",
              message:
                "Erreur avec l'envoi de votre message, veuillez retenter plus tard",
            });
            alertRef.current.showAlert();
          });
      } else {
  ...
  return (
    <div className="home-footer-main">
          ...
          <div className="inside">
            ...
            <ul className="footer-home-list no-list-style">
              ...
              <li>
                {" "}
                <AiOutlineInstagram
                  className="network-icon instagram"
                  color="#555555"
                />{" "}
                <a
                  className="link network"
      ...
      <div className="supports-partners ">
        ...
        <div className="footer-logo">
          <img
            alt="Ville de Saint-Denis"
            src="/images/logos/logo_saint_denis.png"
          />
        </div>
        {/* <div className='footer-logo'>
        ...
        <div className="footer-logo">
          <img
            alt="Mains d'Oeuvres"
            src="/images/logos/logo_mains_doeuvres.png"
          />
        </div>
      </div>
